...
namespace DryingHouse.Persistence.Repositories
{
    public class ProgramFunctionAuthorityRepository : Repository<ProgramFunctionAuthority>
    {
        ...
        public void DeleteByProgramAndFunction(string programName, string functionName)
        {
            ...
            try
            {
                var ProgramFunctionAuthority = ProjectDataContext.ProgramFunctionAuthorities.Where(_ => _.ProgramName.Equals(programName) && _.FunctionName.Equals(functionName)).ToList();
